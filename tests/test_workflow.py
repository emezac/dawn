...
class TestWorkflow(unittest.TestCase):
    ...
    def test_add_task(self):
        ...
        workflow = Workflow(workflow_id="add_task_workflow", name="Add Task Workflow")

        task1 = Task(task_id="task1", name="Task 1", is_llm_task=True)

        task2 = Task(task_id="task2", name="Task 2", is_llm_task=False, tool_name="calculate")
    ...
    def test_add_duplicate_task(self):
        ...
        workflow = Workflow(workflow_id="duplicate_workflow", name="Duplicate Task Workflow")

        task1 = Task(task_id="task1", name="Task 1", is_llm_task=True)

        task2 = Task(task_id="task1", name="Task 2", is_llm_task=True)  # Same ID as task1
    ...
    def test_get_task(self):
        ...
        workflow = Workflow(workflow_id="get_task_workflow", name="Get Task Workflow")

        task = Task(task_id="task1", name="Task 1", is_llm_task=True)
    ...
    def test_get_nonexistent_task(self):
        ...
        workflow = Workflow(workflow_id="nonexistent_workflow", name="Nonexistent Task Workflow")
    ...
    def test_get_next_task(self):
        ...
        workflow = Workflow(workflow_id="next_task_workflow", name="Next Task Workflow")

        task1 = Task(task_id="task1", name="Task 1", is_llm_task=True)

        task2 = Task(task_id="task2", name="Task 2", is_llm_task=True)
    ...
    def test_get_next_task_by_condition(self):
        ...
        workflow = Workflow(workflow_id="conditional_workflow", name="Conditional Workflow")

        task1 = Task(task_id="task1", name="Task 1", is_llm_task=True, next_task_id_on_success="task3")

        task2 = Task(task_id="task2", name="Task 2", is_llm_task=True)

        task3 = Task(task_id="task3", name="Task 3", is_llm_task=True)
    ...
    def test_set_status(self):
        ...
        workflow = Workflow(workflow_id="status_workflow", name="Status Workflow")
    ...
    def test_invalid_status(self):
        ...
        workflow = Workflow(workflow_id="invalid_status_workflow", name="Invalid Status Workflow")
    ...
    def test_is_completed(self):
        ...
        workflow = Workflow(workflow_id="completed_workflow", name="Completed Workflow")
    ...
    def test_to_dict(self):
        ...
        workflow = Workflow(workflow_id="dict_workflow", name="Dict Workflow")
