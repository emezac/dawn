...
class TestConditionalWorkflow(unittest.TestCase):
    ...
    def test_conditional_branch(self):
        ...
        self.assertEqual(next_task.id, "task_b", "Engine should select the failure branch (task_b) when condition is not met")
        ...
        self.assertTrue(len(self.task_b.output_data["response"]) > 100, "Regenerated output should be longer than 100 characters")
        ...
        self.assertEqual(next_after_b.id, "task_success", "Engine should proceed to task_success after regeneration")
