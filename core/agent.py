...
class Agent:
    ...
    Manages workflows, LLM interfaces, and tool registries.
    """
    def __init__(
        self,
        agent_id: str,
    ...
    def register_tool(self, name: str, func: Callable) -> None:
        ...
        print(f"DEBUG: Tool '{name}' registered with agent '{self.id}'. Registry ID: {id(self.tool_registry)}")
    ...
    def run(self) -> Dict[str, Any]:
        ...
        try:
            self.last_results = engine.run()
             ...
             if self.workflow: self.workflow.set_status("failed")
    ...
    def run_async(self) -> Dict[str, Any]:
        ...
        #print(f"DEBUG: Passing ToolRegistry instance ID: {id(self.tool_registry)} to AsyncWorkflowEngine.")
        #print(f"DEBUG: Tools available in registry being passed: {list(self.tool_registry.tools.keys())}")
        # --- End Optional Debug Print ---
